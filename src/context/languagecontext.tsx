...
const translations: Record<string, Record<string, string>> = {
  es: {
        ...
        "home.eco.title": "El ecosistema Digital Estate AI",
        ...
        "services.hero.title": "DIGITAL ESTATE AI –<br>SOLUCIONES PARA<br>INMOBILIARIAS",
        ...
        "about.step3.title": "Automate what matters", // Corregido el original
